...
describe('DistrictRepository iteration 1 - part 1', () =>  {
  ...
  test('findByName returns undefined with no matching arguments', () => {
    expect(district.findByName('Vikings')).toBe(undefined);
  });

  test('findByName returns an object with a district\'s information', () => {
  ...
  test('each district has a data object year : data key value pairs', () => {
